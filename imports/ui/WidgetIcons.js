		...
		<div className="widget widget_icons">
				<div className="widget__content">
					...
					<div className="social__icons">
						...
						<a target="_blank" href="https://twitter.com/LIFElabsHQ"><img title="Twitter" src='/twitter.png' className='icons'/></a>
						<a target="_blank" href="https://www.facebook.com/LIFElabsHQ/"><img title="Facebook" src='/facebook.png' className='icons'/></a>
						<a target="_blank" href="https://www.instagram.com/lifelabshq"><img title="Instagram" src='/instagram.png' className='icons'/></a>
